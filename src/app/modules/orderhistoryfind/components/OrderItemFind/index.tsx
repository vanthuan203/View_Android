        ...
        <tr style={{margin:100,backgroundColor:item.checked==true?"rgba(252,226,207,0.62)":""}}>
            ...
            <td>
                ...
                <br/>
                    ...
                    }}><span style={{color:'#050505',fontWeight:"bold",fontSize:11,marginRight:5,marginBottom:5}} >{new Date(item.end_time).toLocaleDateString('vn-VN').replace("/2024","") +" "+new Date(item.end_time).toLocaleTimeString('vn-VN')}</span>
                    </span>
                    </span>
                    </span></span>}
                    <br/>
                    ...
                    }}><span style={{color:'rgba(159,93,8,0.97)',fontWeight:"bold",fontSize:11,marginRight:5,marginBottom:5}} >{new Date(item.update_current_time).toLocaleDateString('vn-VN').replace("/2024","") +" "+new Date(item.update_current_time).toLocaleTimeString('vn-VN')}</span>
                    </span>
                    </span>
                    </span></span>}
                    {item.refund>0&&<br/>}
                    ...
                    }}><span style={{color:'rgba(218,30,30,0.97)',fontWeight:"bold",fontSize:11,marginRight:5,marginBottom:5}} >{new Date(item.refund_time).toLocaleDateString('vn-VN').replace("/2024","") +" "+new Date(item.refund_time).toLocaleTimeString('vn-VN')}</span>
                    </span>
                    ...
                    }}><span style={{color:'rgba(53,138,10,0.97)',fontWeight:"bold",fontSize:11,marginRight:5,marginBottom:5}} >{new Date(item.refill_time).toLocaleDateString('vn-VN').replace("/2024","") +" "+new Date(item.refill_time).toLocaleTimeString('vn-VN')}</span>
                    </span>
                    <span style={{color:'white',fontSize:10,padding:2,backgroundColor:"#03d96e",marginRight:5,marginBottom:5}} className='badge badge-success'>
                            {item.refill}
                        </span>
            ...
            <td className='text-dark fw-bolder text-hover-primary text-sm'>
                {item.total>0&&item.update_current_time>0&&<span>
                    ...
                    {item.update_current_time!=null&&item.update_current_time>0&&<span style={{color:'white',fontSize:10,padding:2,backgroundColor:"rgba(31,155,229,0.66)",marginRight:5,marginBottom:5}} className='badge badge-success'>
